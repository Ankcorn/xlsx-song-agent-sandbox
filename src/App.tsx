  ...
  return (
    <section className="benchmark-page analytics-page">
      <aside className="analytics-sidebar">
        ...
        <button className="secondary-button clear-button" type="button" onClick={() => setRuns([])} disabled={runs.length === 0}>
          <Trash2 size={16} />
      ...
      <main className="analytics-main">
        ...
        <form className="thoughtspot-search" onSubmit={submitBenchmark}>
          ...
          <button className="primary-button" type="submit" disabled={isRunning || !prompt.trim()}>
