/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0aa414a4b4a81b8884167f0cdee9ca54)
// Runtime types generated with workerd@1.20260623.1 2026-06-25 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	ASSETS: Fetcher;
	HackathonAgent: DurableObjectNamespace<import("./src/worker").HackathonAgent>;
	Sandbox: DurableObjectNamespace<import("./src/worker").Sandbox>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "HackathonAgent" | "Sandbox";
	}
